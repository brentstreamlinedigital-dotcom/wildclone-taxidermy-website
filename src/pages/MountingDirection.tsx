          ...
          <div className="flex flex-col gap-6 mb-12">
            ...
            <AnimatedSection delay={0}>
              <div className="rounded-2xl border border-border bg-black overflow-hidden">
                ...
                {/* Show top half: container is 62% of the natural image height */}
                <div className="relative overflow-hidden w-full" style={{ paddingBottom: "62%" }}>
                  <img
                    src="/images/diagram_inverted.jpg"
                    alt="Shoulder Mount Direction Diagram"
                    className="absolute inset-0 w-full"
                    style={{ top: "4%", height: "200%" }}
                  />
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.1}>
              <div className="rounded-2xl border border-border bg-black overflow-hidden">
                ...
                {/* Show bottom half: push image up by 102% */}
                <div className="relative overflow-hidden w-full" style={{ paddingBottom: "62%" }}>
                  <img
                    src="/images/diagram_inverted.jpg"
                    alt="Wall Pedestal Mount Direction Diagram"
                    className="absolute w-full"
                    style={{ top: "-102%", height: "200%" }}
                  />
                </div>
              </div>
            </AnimatedSection>
